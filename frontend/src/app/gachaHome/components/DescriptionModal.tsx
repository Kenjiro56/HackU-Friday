...
const DescriptionModal: React.FC<ModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-cente z-50r">
      <div className="fixed inset-0 bg-black opacity-50" onClick={onClose}></div>
      {/* モーダル本体 */}
      <div className="bg-white rounded-xl p-6 w-80 shadow-lg border-black border-2 z-10 fixed left-1/2 transform -translate-x-1/2">
